...
(function (global, factory) {
    ...
    var root$x = from_html(`<div><div role="alert"><button type="button" class="close-btn svelte-ysaqmb" aria-label="Dismiss intro">×</button> <p class="text svelte-ysaqmb"> </p></div></div>`);
    ...
    var root_1$h = from_html(`<button type="button" class="cv-dismiss-btn svelte-122ln5" aria-label="Dismiss settings icon">✕</button>`);
    var root$v = from_html(`<div role="none"><button type="button" class="cv-settings-main-btn svelte-122ln5"><span class="cv-gear svelte-122ln5"><!></span></button> <button type="button" class="cv-collapse-btn svelte-122ln5" aria-label="Collapse settings icon"> </button> <!></div>`);
    ...
    var root$u = from_svg(`<svg><path d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z"></path></svg>`);
    ...
    var root$q = from_svg(`<svg><path fill="currentColor" d="M18 8h-2a1 1 0 0 0 0 2h2v8H6v-8h2a1 1 0 0 0 0-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2z"></path><path fill="currentColor" d="M11 6.41V12a1 1 0 0 0 2 0V6.41l1.29 1.3a1 1 0 0 0 1.42 0a1 1 0 0 0 0-1.42l-3-3a1 1 0 0 0-1.42 0l-3 3a1 1 0 1 0 1.42 1.42L11 6.41z"></path></svg>`);
    ...
    var root$o = from_svg(`<svg><path d="M 19.28125 5.28125 L 9 15.5625 L 4.71875 11.28125 L 3.28125 12.71875 L 8.28125 17.71875 L 9 18.40625 L 9.71875 17.71875 L 20.71875 6.71875 Z"></path></svg>`);
    ...
    var root_2$b = from_html(`<span class="segment-icon svelte-1osj0o5"><!></span>`);
    var root_1$g = from_html(`<button type="button"><!> <span class="segment-label svelte-1osj0o5"> </span></button>`);
    var root$l = from_html(`<div role="group"></div>`);
    ...
    var root$k = from_html(`<div class="card svelte-gwkhja"><div class="content svelte-gwkhja"><div><p class="title svelte-gwkhja"> </p> <!></div> <!></div></div>`);
    ...
    */
    ...
    var root_2$4 = from_html(`<button type="button" aria-label="Previous highlight">↑</button> <button type="button" aria-label="Next highlight">↓</button>`, 1);
    ...
    var root_4 = from_html(`<!> <span class="cv-expand-label svelte-1ka2eec">Show more</span>`, 1);
    var root_2$3 = from_html(`<button type="button" class="cv-expand-btn svelte-1ka2eec"><!></button>`);
    ...
    var root_2$2 = from_html(`<div class="card svelte-1lfe2lv"><div class="content svelte-1lfe2lv"><div><p class="label svelte-1lfe2lv"> </p> <!></div> <!></div></div>`);
    ...
    function ToggleControl($$anchor, $$props) {
    	...
    	let toggleId = prop($$props, 'toggleId', 7, ''),
    		noLabel = prop($$props, 'noLabel', 7, false);
...

    	{
    		var consequent_2 = ($$anchor) => {
...

    			{
    				...
    				if_block(node_1, ($$render) => {
    					if (!noLabel()) $$render(consequent_1); else $$render(alternate, false);
    				});
    			}
    ...
    var root$2 = from_html(`<div class="cv-tabgroup-container svelte-1ujqpe3"><!> <!> <div class="cv-tabgroup-content"><!></div> <div class="cv-tabgroup-bottom-border svelte-1ujqpe3"></div></div>`);
